...
scatterplotp <- function(x, y, z=NULL, xlab=NULL, ylab=NULL, log="", main=NULL, description=NULL, col="#789aa1") {
  ...
  # Linear regression
  # alm[is.na(alm)] <- 0
  # lmfit <- lm(alm[[plos.y]] ~ alm[[plos.x]], na.action=na.omit, subset=alm[[plos.x]] <= plos.fitmax)
